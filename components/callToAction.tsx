        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex flex-col space-y-6">
            <p className="text-zinc-300 text-lg tracking-tight">
              Experience the future of music with our AI agents and create your own music.
            </p>
            <Button 
              className="bg-foreground text-background hover:bg-zinc-100 px-6 py-3 rounded-full font-medium text-sm self-start"
